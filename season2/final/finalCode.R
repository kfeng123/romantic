...
par(mfrow=c(1,1))
myPlotTot(finalTot$purchase_bal_amt)
myPlotTot(finalTot$purchase_bank_amt)
myPlotTot(finalTot$total_purchase_amt)
myPlotTot(finalTot$total_redeem_amt)
myPlotTot(finalTot$consume_amt)
myPlotTot(finalTot$category1)
myPlotTot(finalTot$category2)
myPlotTot(finalTot$category3+finalTot$category4)
myPlotTot(finalTot$total_redeem_amt-(finalTot$category3+finalTot$category4))

myPlotTot(finalTot$total_redeem_amt-finalTot$tftocard_amt)
myPlotTot(finalTot$tftocard_amt)
