...
#################模型
##########purchase
formulaStr="purchase~S1+S2+S3+S4+S5+S6+yuechu+buxiu+jiaqiN+jiaqi6+jiaqi7+s(jihao,k=31)"
...
p1=exp(predict(finalFit,toP))

formulaStr="purchase~S1+S2+S3+S4+S5+S6+yuechu+buxiu+jiaqiN+jiaqi6+jiaqi7"
myFeature$purchase=finalTot$total_purchase_amt
finalFit=gam(as.formula(formulaStr),data=myFeature[275:427,],family=Gamma(link="log"))
p2=exp(predict(finalFit,toP))
#################redeem模型
formulaStr="redeem~S1+S2+S3+S4+S5+S6+buxiu+jiaqiN+jiaqi6+jiaqi7+qian1+s(jihao,k=31)"
myFeature$redeem=finalTot$total_redeem_amt
finalFit=gam(as.formula(formulaStr),data=myFeature[275:427,],family=Gamma(link="log"))
r1=exp(predict(finalFit,toP))

formulaStr="redeem~S1+S2+S3+S4+S5+S6+buxiu+jiaqiN+jiaqi6+jiaqi7+qian1"
myFeature$redeem=finalTot$total_redeem_amt
finalFit=gam(as.formula(formulaStr),data=myFeature[275:427,],family=Gamma(link="log"))
r2=exp(predict(finalFit,toP))